...
Client.prototype.request = function(options, callback) {
  ...
  options = options || {};
  var requestUrl = _requestUrl(network, version, auth, options)
...
function _requestUrl(network, version, auth, options) {
  // Building URL
  ...
  if (auth) {
    options.params = _.extend(options.params, {'auth': auth})
  }
